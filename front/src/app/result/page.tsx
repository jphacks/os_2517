    ...
    <div className="fixed inset-0 overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4 md:p-8">
      <div className="max-w-5xl w-full flex flex-col h-full py-4">
        ...
        <div className="text-center mb-4 md:mb-6 animate-fadeIn flex-shrink-0">
          ...
          <p className="text-purple-200/90 text-sm sm:text-base md:text-lg leading-relaxed">
            時を超えて辿り着いた、あの日の情景
          </p>
        </div>

        {/* 画像表示 */}
        <div className="relative backdrop-blur-xl bg-white/10 rounded-3xl shadow-2xl border border-white/20 p-4 sm:p-6 mb-4 md:mb-6 animate-slideUp flex-1 flex flex-col min-h-0">
          ...
          {/* 時間の刻印 */}
          <div className="mt-3 sm:mt-4 text-center text-purple-200/80 text-xs sm:text-sm md:text-base font-serif flex-shrink-0">
            <p>過去から切り取られた一瞬</p>
          </div>
        </div>
